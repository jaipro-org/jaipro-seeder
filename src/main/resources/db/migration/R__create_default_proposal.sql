...
begin
	...
	insert into jaipro.service_proposal(service_request_id, customer_id, profession_id, status_proposal, proposal, prof_name,
										prof_last_name, prof_public_url, min_cost, max_cost, created_by, creation_date, specialist_id)
	select
