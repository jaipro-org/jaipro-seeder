CREATE OR REPLACE FUNCTION jaipro.get_detail_commission_service_payment(p_payment_id int)
    RETURNS TABLE
            (
...
begin
    ...
    return query (select sr.service_request_id,
                  ...
                  from service_proposal sp
                           ...
                           left join payment p2 on sr.service_request_id = p2.service_request_id and
                                                   p2."type" = v_type_payment_service
